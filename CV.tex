...
\subsection{\textbf{Amadeus}}
\cventry{2020 - }{développeur cloud}{}{}{}
{
Migration du produit paiement au private cloud et Microsoft Azure
}
\cventry{2016 - 2020}{développeur cloud}{}{}{}
{
Migration du produit flight search a google cloud engine à l'aide d'OpenShift / Kubernetes / docker
}
\cventry{2013 - 2016}{développeur C++}{}{}{}
{
Développement d'un algorithme de recherche de vols avec de fortes contraintes de performances (Plus de 100k tps, réponse ~100ms)
}
%\cvlistitem{migration}
%\cvlistitem{second}
\cventry{2010 - 2013}{développeur C++}{}{}{}
{
Migration technique des données vols depuis le système TPF (IBM) vers une architecture micro service développé en interne
}
\subsection{\textbf{Ubisoft}}
...
%% Example usages:
\cvskillentry*{Languages:}{4}{C++}{}{Dev backend, optim. de performances}
...
\vspace{15pt}
\cvitem{Autres:}{mongo, kafka, perl, java, javascript, git, \LaTeX}
