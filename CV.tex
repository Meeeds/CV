...
{
Développement d'un algorithme de recherche de vols avec de fortes contraintes de performances (Plus de 10k tps, réponse ~100ms)
}
...
%% Example usages:
\cvskillentry*{Language:}{4}{C++}{}{Dev backend, optim. de performances}
