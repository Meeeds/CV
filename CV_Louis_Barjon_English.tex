...
\cvlistitem{Oracle Migration: smooth migration from Oracle 12 to 18 with no outage }
...
\cvskillentry*{Programming:}{5}{C\texttt{++}}{}{Dev backend, performances optim. }
...
\vspace{5pt}
\cvitem{Others:}{Kafka, Java, Javascript, Git, VScode, \LaTeX}
% removed eclipse
