...
\email{louis.barjon@amadeus.com}                  % optional, remove / comment the line if not wanted
...
\cventry{2021 - }{Developer MDW cloud for TPE}{}{}{}{}
\cvlistitem{Design of the job migration to ACS inside the batches SCRUM team}

\renewcommand*{\listitemsymbol}{\labelitemi~}

\cventry{2020 - 2021}{Developer cloud/C\texttt{++} in Payment}{}{}{}
{}
\cvlistitem{Migrate the payment product to Ironman and Microsoft Azure}
\cvlistitem{Code quality enforcement with SonarQube 
%\inlinegraphics{sonar}
}
\cventry{2016 - 2020}{Developer cloud in the Shopping Tribe}{}{}{}{}
\cvlistitem{Migrate Travel Solution Builder product to the cloud using OpenShift / Kubernetes / Docker}
\cvlistitem{Data migration from Oracle to Couchbase C\texttt{++}}
\cventry{2013 - 2016}{Developer C\texttt{++} in Journey Server}{}{}{}{}
\cvlistitem{Development of the Travel Solution Builder product with high performance constraints  (more than 100k tps, reply $\sim$100ms)}
\cvlistitem{Oscar Project: MCT algorithm optimization: number of instructions divided by 5 and a 20\% decrease of the global Master Pricer CPU }
...
\cventry{2010 - 2013}{Developer C\texttt{++} in Flight Data}{}{}{}{}
\cvlistitem{Flight Data migration from TPF to OBE}
...
\cventry{2010}{Developer middleware C\texttt{++}}{}{}{}{}
\cvlistitem{Strong code quality: 100\% code coverage, performances test, etc }

\section{Education}
\cventry{2010}{Software Engineer}{Ensimag}{}{}{Speciality: imaging and virtual reality}
...
%% Example usages:
\cvskillentry*{}{3}{English}{}{Used every day for work, social, and hobbies}
\cvskillentry*{Languages:}{4}{C\texttt{++}}{}{Dev backend, performances optim. }
...
\cvskillentry*{Méthodes:}{4}{Scrum, Kanban, Safe, Jira}{}{Work with agile since 2015}
...
\cvitem{Science}{Physics, mathematics }
