...
\subsection{\textbf{Amadeus}, Nice, Sophia Antipolis}
...
% \cvline{}{description}
\cvlistitem{Java Developer in hotel distribution \& Azure migration. Kafka, Couchbase, Oracle DB}
%\cvlistitem{Development in hotel distribution \& Azure migration. Java Spring Boot \& Camel, Kafka, Couchbase}
\cvlistitem{Develop 3 python tools to help $\sim$100 Devs migrate their apps to the cloud}

% \renewcommand{\listitemsymbol}{}
\cventry{2021 - 2022}{Developer middleware cloud}{}{}{}{}
\cvlistitem{Design \& develop of a generic tool to ease cloud migration of batches, used by $\sim$thousands Devs}
...
\section{Education}
\cventry{2010}{Computer science Engineer}{Ensimag}{}{Speciality: imaging and virtual reality}{}
