...
% doesnt work https://tex.stackexchange.com/questions/14306/link-formatting-colors-underlines-in-moderncv
\recomputelengths
...
\quote{\large \textsc{Senior Engineer Cloud, DevOps \& C\texttt{++}}}
...
% \cvline{}{description}
\cvlistitem{Migrate 30 Java Spring BE for hotel distribution in Azure using Helm charts. Architecture: Kafka, Couchbase, Oracle}
...
\cvlistitem{Create a testing framework in bash in order to validate code changes}
\cvlistitem{Simplify a complex architecture for better scalability and robustness, in particular by removing a single point of failure}
...
\cvlistitem{Advanced programming knowledge sharing sessions: Drive and present on a bi-weekly basis a complex technical subject to the department}
...
\cvlistitem{Product migration from TPF system (IBM) to a micro-service architecture, using an internal MDW}
\cvlistitem{Develop a python tool in order to tests iso-functional behavior between TPF \& OBE }



\subsection{\textbf{Ubisoft}, Montpellier, France}
\cventry{2010}{C\texttt{++} physics engine developer, middleware}{}{}{}{}
\cvlistitem{Develop and improve an Algorithm to detect 3D models collisions}
\cvlistitem{Improve unit tests to Achieve 100\% code coverage}
\cvlistitem{Run C\texttt{++} profiling using callgrind to decrease CPU by 10\% }
...
\section{Education}
\cventry{2010}{Master in Computer Science, Engineer}{}{}{}{}
\cvlistitem{Ensimag school in Grenoble, Specialty: imaging and virtual reality}
\cvlistitem{ Develop an \textcolor{cyan}{\href{http://www-evasion.imag.fr/Enseignement/cours/2009/ProjetImage/}{algorithm from a research paper}} to generate textures from a small image sample}
...
\cvskillentry*{Programming:}{5}{C\texttt{++}}{}{Dev backend, performances optimization}
\cvskillentry{Programming:}{5}{Python}{}{Dev backend, Tooling, Data science }
\cvskillentry{}{3}{GoLang, Bash, Groovy}{}{Tools, scripting, CI/CD}
%dispatching framework with gRPC-go
\cvskillentry{}{2}{Sql, Couchbase, MongoDB}{}{Data management and migration}
\cvskillentry*{Cloud:}{4}{Openshift, Helm, Kube, Docker}{}{Software migration to gce/Azure}
