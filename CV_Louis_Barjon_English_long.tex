...
\quote{Senior developer cloud \& C\texttt{++}}
...
\cventry{2022 -  }{Java \& Cloud developer for Hospitality}{}{}{}{}
% \cvline{}{description}
\cvlistitem{Migrate 30 Java Spring BE for hotel distribution in Azure. Architecture: Kafka, Couchbase, Oracle}
...
\cvlistitem{Enforce a Unit test framework in Hotel division. Multiply number of tests by 2 in 6 months}
...
\cvlistitem{Product migration from TPF system (IBM) to a micro-service architecture (OBE), using an internal MDW}
...
\section{Hobbies}
\cvdoubleitem{\textbf{Games:}}{Board games, game of go, chess}{\textbf{Sports:}}{Hiking, Running, fitness}
% \cvitem{Games}{Board games, game of go, chess}
\cvdoubleitem{\textbf{Science:}}{Physics, mathematics, philosophy}{\textbf{Riddles:}}{logic, physics}
